...
public class ConceptManager implements Serializable {
	 ...
	 */
	public void belongsTo(Class mobiClass, Attribute attribute) throws ExceptionURI {
...
//		 classA.getUri().length() + 1 + quantity);
	...
	public void setAllClassAttributeRelation(
			HashMap<String, Set<Attribute>> allClassAttributeRelation) {
